...
<tr>
    ...
    <td style="width: 15cm">
       <p style="font-size: 7px; font-style: italic;">De analyseresultaten hebben uitsluitend betrekking op het/de onderzochte monster(s). Dit rapport mag zonder schriftelijke toestemming van Micro-Analyse Zeeland, niet <br />
        ...
        analysemethoden en de identiteit van de door externe laboratoria (E) uitgevoerde analyses zijn opvraagbaar. <br />
        Micro-Analyse Zeeland is door de Raad voor Accreditatie geaccrediteerd volgens ISO 17025 en staat geregistreerd onder nummer L420.<br />
