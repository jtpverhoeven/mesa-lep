...
<tr>
    ...
    <td style="width: 15cm">
    <p style="font-size: 7px; font-style: italic;"> The results relate only to the analyzed sample(s). This report may only be reproduced in its entirety - exceptions are allowed only with written permission from <br />
    Micro-Analyse Zeeland. Remarks expressed in this report are not covered by accreditation. The performance characteristics of the accredited analytical methods<br />
    and the identity of external laboratories for outsourced analyses are available on request. <br />
    Micro-Analyse Zeeland is accredited by the Dutch Accreditation Council (RvA) according to ISO 17025 and registered under number L420.<br />
    ...
    Results are expressed as cfu per gram or ml. of the sample, unless stated otherwise.<br /></p>
    </td>



    <td style="text-align: right; vertical-align: top;"> <p style="font-size: 7px"> Page {PAGENO} of [pagetotal] </p>  </td>
