...
<tr>
    ...
    <td style="width: 15cm">
       <p style="font-size: 7px; font-style: italic;">De analyseresultaten hebben uitsluitend betrekking op het/de onderzochte monster(s). Dit rapport mag zonder schriftelijke toestemming van Micro-Analyse Zeeland, niet <br />
        anders dan in zijn geheel worden gereproduceerd. Opmerkingen vermeld op dit certificaat vallen niet onder accreditatie. De prestatiekenmerken van de geaccrediteerde <br />
        analysemethoden zijn opvraagbaar. Micro-Analyse Zeeland is door de Raad voor Accreditatie geaccrediteerd volgens ISO 17025 en staat geregistreerd onder nummer L420.<br />
        ...
        Resultaten zijn uitgedrukt in kve per gram of ml. van het onderzochte monster, tenzij anders vermeld.
      </p>
    </td>
...
<tr>
    <td style="width: 10cm;  vertical-align: bottom;"><img src="{usr_sig}" style="max-width: 3.5cm;" /></td>
    <td style="text-align: right; vertical-align: bottom;">&nbsp;<img src="<?PHP print ROOT . '/app/docgen/res/L420-color-nl.jpg';?>" style="width: 1.49cm;" /></td>
</tr>
