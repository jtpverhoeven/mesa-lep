                ...
                <aside class="sidebar">
                    ...
                    <nav aria-label="Werkruimtenavigatie">
                        ...
                        @else
                            ...
                            @can('samples.create')<a href="{{ route('samples.create') }}" @class(['selected' => request()->routeIs('samples.create')])>Monster aanmelden</a>@endcan
                            @can('samples.view')<a href="{{ route('samples.lookup') }}" @class(['selected' => request()->routeIs('samples.lookup*')])>Monster opzoeken</a>@endcan
