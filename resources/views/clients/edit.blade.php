...
@section('content')
    ...
    <div data-client-form="{{ json_encode(['client' => $client, 'categories' => $categories, 'action' => route('clients.update', $client), 'method' => 'PUT', 'submitLabel' => 'Wijzigingen opslaan', 'cancelUrl' => route('clients.index'), 'csrf' => csrf_token()]) }}"></div>
@endsection